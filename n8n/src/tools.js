...
const ORDER_RULE =
  ...
  "SETELAH ORDER BERHASIL (TRANSFER): 'Siap kak.. orderan kakak sudah saya masukkan ke prioritas pengiriman..' lalu kirim link pembayaran dari hasil tool + total, bilang paket langsung diproses setelah pembayaran masuk, tutup dengan doa singkat dan 'Terima kasih\nCS Filomall-Beauty'.";
